    ...
    document.addEventListener(
        ...
        (event) => {
            ...
            if(word.innerText == guessWord) {
                score.innerText = "Your guessed the word correctly"
                container.style.display = "none"
                word.style.display = 'none'
                score_container.style.display = "block"
                score_container.style.margin = "100px"
...
async function hint(element) {
    try {
        ...
        console.log(error + " Could not fetch data Make sure your connected to internet")
    }
}